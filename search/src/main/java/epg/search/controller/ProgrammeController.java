...
public class ProgrammeController {
	...
	public ResponseEntity<Page<ProgrammeDoc>> nowChannels(@RequestParam(required = true) List<String> channels,
			Pageable pageable) {
		return ResponseEntity.ok(programmeService.now(channels, pageable));
	}
